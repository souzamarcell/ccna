const questions = [
  ...
  {
    question: 'Qual modelo de referência é conhecido por possuir sete camadas?',
...
{
  question: 'Qual camada do modelo OSI é responsável pela transmissão de bits no meio físico?',
...
{
  question: 'Qual camada do modelo OSI é responsável por estabelecer e encerrar sessões?',
...
{
  question: 'Qual camada do modelo OSI fornece serviços diretamente ao usuário final?',
...
{
  question: 'Qual camada do modelo OSI trabalha com endereçamento lógico IP?',
  options: ['Rede', 'Transporte', 'Aplicação', 'Física'],
  answer: 'Rede',
  clue: 'A camada 3 utiliza endereços IP.',
},
{
  question: 'Qual camada do modelo OSI é responsável pelo controle de fluxo e confiabilidade ponta a ponta?',
...
{
  question: 'Qual camada do modelo OSI é responsável por converter dados em formato compreensível para a aplicação?',
...
{
  question: 'Qual camada do modelo OSI é responsável pela transmissão do sinal elétrico ou óptico?',
  options: ['Física', 'Enlace', 'Rede', 'Aplicação'],
  answer: 'Física',
